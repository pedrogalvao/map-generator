...
fn img_to_map_coords_north(
    ...
    let latitude = 180.0 * dist_to_center as f32 / img_height.min(img_width) as f32 - 90.0;
...
impl Projection for DoubleAzimutal {
    fn new() -> Self {
        Self {}
    }
    ...
    fn map_to_img_coords(
        ...
        let dist_to_center = (90.0 - latitude.abs()) * img_height as f32 / 180.0;
        let longitude_rad = (90.0 - longitude) * PI / 180.0;
        let img_x = center_x + dist_to_center as f32 * longitude_rad.sin();
        let img_y = center_y + dist_to_center as f32 * longitude_rad.cos();
